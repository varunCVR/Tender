...
namespace VLB
{
    public static class FoldableHeader
    {
        ...
        public static bool Begin(UnityEngine.Object self, GUIContent label)
        {
            ...
            var folded = ms_FoldedHeaders.Contains(uniqueString);
        ...
        {
            Debug.Assert(ms_CurrentFoldableHeader != null,
                "Trying to call FoldableHeader.End() but there is no header opened");
            ms_CurrentFoldableHeader = null;
        ...
        private static string ms_CurrentFoldableHeader = null;
        private static HashSet<string> ms_FoldedHeaders = new HashSet<string>();
        private static GUIStyle ms_StyleHeaderFoldable = null;
    }
}
#endif // UNITY_EDITOR