...
namespace VLB
{
    ...
    {
        private SerializedProperty depthMapResolution = null;
        private SerializedProperty layerMask = null;
        private SerializedProperty useOcclusionCulling = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_Targets.HasAtLeastOneTargetWith((DynamicOcclusionDepthBuffer comp) =>
                {
                    return comp.GetComponent<VolumetricLightBeam>().dimensions == Dimensions.Dim2D;
                }))
            ...
            if (FoldableHeader.Begin(this, EditorStrings.DynOcclusion.HeaderCamera))
            {
                ...
                else if (m_Targets.HasAtLeastOneTargetWith((DynamicOcclusionDepthBuffer comp) =>
                         {
                             return comp.HasLayerMaskIssues();
                         }))
                ...
                EditorGUILayout.PropertyField(useOcclusionCulling,
                    EditorStrings.DynOcclusion.DepthBufferOcclusionCulling);
                EditorGUILayout.PropertyField(depthMapResolution,
                    EditorStrings.DynOcclusion.DepthBufferDepthMapResolution);
            }
