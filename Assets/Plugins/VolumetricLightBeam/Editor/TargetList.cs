...
namespace VLB
{
    ...
    {
        public int Count => m_Targets != null ? m_Targets.Count : 0;
        public T this[int key] => m_Targets != null ? m_Targets[key] : null;

        public List<T> m_Targets = null;

        public TargetList(Object[] entities)
        {
        ...
        public void RecordUndoAction(string name, System.Action<T> lambda)
        {
            ...
            foreach (var target in m_Targets) lambda(target);
        }
