...
namespace VLB
{
    ...
    {
        private SerializedProperty componentsToChange = null;
        private SerializedProperty restoreBaseIntensity = null;
        ...
        public sealed override void OnInspectorGUI()
        {
            ...
            if (m_Targets.HasAtLeastOneTargetWith((T comp) =>
                {
                    return comp.GetComponent<UnityEngine.Light>() == null &&
                           comp.GetComponent<VolumetricLightBeam>() == null;
                }))
            {
            ...
            {
                componentsToChange.CustomMask<EffectAbstractBase.ComponentsToChange>(EditorStrings.Effects
                    .ComponentsToChange);
