...
namespace VLB
{
    ...
    {
        private SerializedProperty alpha = null;
        private SerializedProperty size = null;
        private SerializedProperty direction = null;
        private SerializedProperty velocity = null;
        private SerializedProperty density = null;
        private SerializedProperty spawnDistanceRange = null;
        private SerializedProperty cullingEnabled = null;
        private SerializedProperty cullingMaxDistance = null;

        private static bool AreParticlesInfosUpdated()
        {
        ...
        {
            return AreParticlesInfosUpdated();
        }
