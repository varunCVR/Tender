...
v2f vertShared(vlb_appdata v, float outsideBeam)
{
    ...
    // make segment tessellation denser near the source, since beam is usually more visible at start
...
half4 fragShared(v2f i, float outsideBeam)
{
    ...
    {
        float fadeWithCameraEnabled = 1 - VLB_CAMERA_ORTHO;
        // fading according to camera eye position doesn't make sense with ortho camera
