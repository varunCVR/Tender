...
namespace VLB
{
    ...
    public class EffectFlicker : EffectAbstractBase
    {
        ...
        /// </summary>
        [Range(1.0f, 60.0f)] public float frequency = Consts.Effects.FrequencyDefault;
        ...
        /// A random value will be picked each time inside that range.
        /// </summary>
        [MinMaxRange(0.0f, 10.0f)] public MinMaxRangeFloat pauseDuration = Consts.Effects.PauseDurationDefault;
        ...
        /// </summary>
        [Range(0.0f, 0.25f)] public float smoothing = Consts.Effects.SmoothingDefault;


        private float m_CurrentAdditiveIntensity = 0.0f;
        ...
        private IEnumerator CoUpdate()
        {
            while (true)
            {
                ...
                var remaining = pauseDuration.randomValue;
                do
                {
        ...
        private IEnumerator CoChangeIntensity(float expectedDuration, float nextIntensity)
        {
            ...
            {
                m_CurrentAdditiveIntensity =
                    Mathf.SmoothDamp(m_CurrentAdditiveIntensity, nextIntensity, ref velocity, smoothing);
