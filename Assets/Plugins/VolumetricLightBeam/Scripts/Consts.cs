...
namespace VLB
{
    public static class Consts
    {
        ...
        public static class Internal
        {
            ...
            public static HideFlags ProceduralObjectsHideFlags => ProceduralObjectsVisibleInEditor
        ...
        {
            public const EffectAbstractBase.ComponentsToChange ComponentsToChangeDefault =
                (EffectAbstractBase.ComponentsToChange) int.MaxValue;
        ...
        public static class Config
        {
            ...
            public const FeatureEnabledColorGradient FeatureEnabledColorGradientDefault =
