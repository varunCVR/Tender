...
namespace VLB
{
    ...
    {
#if UNITY_EDITOR
        private static BuildTarget ms_BuildTargetOverride = BuildTarget.NoTarget;
        ...
        {
            if (BuildPipeline.isBuildingPlayer && ms_BuildTargetOverride != BuildTarget.NoTarget)
                return ms_BuildTargetOverride;
