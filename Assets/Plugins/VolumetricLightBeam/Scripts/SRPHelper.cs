...
namespace VLB
{
    public static class SRPHelper
    {
        ...
        private static RenderPipeline m_RenderPipelineCached = RenderPipeline.Undefined;
        ...
        public static bool IsUsingCustomRenderPipeline()
        {
            ...
            return AliasCurrentPipeline.currentPipeline != null ||
        ...
        {
            if (IsUsingCustomRenderPipeline()) AliasCameraEvents.beginCameraRendering -= cb;
        }
#else
