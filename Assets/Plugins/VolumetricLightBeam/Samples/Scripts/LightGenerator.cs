...
namespace VLB_Samples
{
    ...
    {
        [Range(1, 100)] [SerializeField] private int CountX = 10;
        [Range(1, 100)] [SerializeField] private int CountY = 10;
        [SerializeField] private float OffsetUnits = 1;
        ...
        public void Generate()
        {
            ...
            for (var j = 0; j < CountY; ++j)
            {
                GameObject gao = null;
                if (AddLight)
                    gao = new GameObject("Light_" + i + "_" + j, typeof(Light), typeof(VLB.VolumetricLightBeam),
                        typeof(Rotater));
                else
    ...
    public class LightGeneratorEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Generate")) (target as LightGenerator).Generate();
        }
    }
#endif
}