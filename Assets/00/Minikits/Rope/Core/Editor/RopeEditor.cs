    ...
    public class RopeEditor : Editor
    {
        ...
        public void OnSceneGUI()
        {
            ...
            for (int i = 0; i < rope.spawnPoints.Count; i++)
            {
                ...
                {
                    //var fmh_69_65_638334933804780299 = Quaternion.identity; position = Handles.FreeMoveHandle(position, rope.radius * 4.0f, Vector3.one * 0.5f, Handles.SphereHandleCap);
                }
